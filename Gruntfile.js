...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/Demo.st', // list all sources in dependency order
                    'src/Demo-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-demo',
                libraries: ['SUnit', 'Web']
            },
            test_runner: {
                ...
                libraries: [
                    ...
                    'Demo', /* add other code-to-test packages here */
                    'SUnit',
                    'Demo-Tests' /* add other test packages here */
                ],
